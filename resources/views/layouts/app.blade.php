...
<div class="shadow bg-danger text-white text-center p-3 rounded">
		  ...
		  @if (Auth::guest())
           ...
           <hr class="bg-white">
            ...
            <a class="text-light" href="{{ url('/get-started') }}">Get Started</a>
			 <hr class="bg-white">
          
            <a class="text-light" href="{{ url('/download-larang-laravel-angular-blogs') }}">Download</a>
			 <hr class="bg-white">
      ...
      @else
           ...
           <hr class="bg-white">
            ...
            <a class="text-light" href="{{ url('/auth/login') }}">Login</a><hr class="bg-white">
		
         
            <a class="text-white" href="{{ url('/auth/register') }}">Register</a><hr class="bg-white">
         
            <a class="text-light" href="#" role="button" aria-expanded="false">Login as {{ Auth::user()->name }}</a>
           <hr class="bg-white">
              @if (Auth::user()->can_post())
             
                <a class="text-light" href="{{ url('/new-post') }}">Add new post</a><hr class="bg-white">
            
                <a class="text-light" href="{{ url('/user/'.Auth::id().'/posts') }}">My Posts</a><hr class="bg-white">
            
              @endif
             
                <a class="text-light" href="{{ url('/user/'.Auth::id()) }}">My Profile</a><hr class="bg-white">
